...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 flex flex-col font-sans antialiased selection:bg-[#DC2626] selection:text-white">
      ...
      <div className="fixed bottom-6 right-6 z-30 hidden sm:flex items-center gap-2 bg-[#0B1B2D] text-white p-2 pr-4 rounded-full shadow-2xl border border-slate-700/80 hover:scale-105 transition-transform duration-300">
        <button 
