    ...
    <footer id="contact" className="bg-[#07111E] text-slate-300 pt-16 pb-8 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-slate-800/80">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2 text-slate-400">
              <a href="#home" className="w-8 h-8 rounded-full bg-slate-800/80 hover:bg-[#DC2626] hover:text-white flex items-center justify-center transition-colors" aria-label="Facebook">
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
              </a>
              <a href="#home" className="w-8 h-8 rounded-full bg-slate-800/80 hover:bg-[#DC2626] hover:text-white flex items-center justify-center transition-colors" aria-label="Instagram">
              ...
              <a href="#home" className="w-8 h-8 rounded-full bg-slate-800/80 hover:bg-[#DC2626] hover:text-white flex items-center justify-center transition-colors" aria-label="Youtube">
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs font-inter font-normal text-slate-500 gap-2">
          <p>© 2025 Vertex Cricket Academy. All Rights Reserved.</p>
